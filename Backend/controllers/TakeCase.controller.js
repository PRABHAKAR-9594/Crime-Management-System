...
export const TakeCase_controller = async (req, res) => {
    const crimetype = req.body.crimetype
    const status = req.body.status

    try {
        const response = await crimeRegFormModel.find({
            crimetype: crimetype, status: status
        })
...
export const updateAssignedOfficer_controller = async (req, res) => {
    try {
